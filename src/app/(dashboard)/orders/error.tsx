...
export default function OrdersError({ reset }: ErrorProps) {
    return (
        <div className="flex min-h-[60vh] items-center justify-center">
            <div className="max-w-sm w-full text-center card p-8">
                <div className="text-4xl mb-4">🛒</div>
                <h2 className="text-lg font-semibold text-[var(--text-primary)] mb-2">Failed to load orders</h2>
                <p className="text-sm text-[var(--text-secondary)] mb-6">Could not fetch order data.</p>
